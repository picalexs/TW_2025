...
-- Insert into users
-- Colonnele sunt: id, username, password_hash, email, is_verified, email_token, token_expires, address_id, role, created_at
...
-- Changed ID to 6 and name to a distinct one
...
-- Using tag_id 3 for 'Needs Medication' (the corrected one)
...
-- Whiskers, Needs Medication (ID 3)
