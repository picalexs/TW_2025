...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE system_notifications CASCADE CONSTRAINTS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE adoption_status_history CASCADE CONSTRAINTS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE animal_metrics CASCADE CONSTRAINTS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
